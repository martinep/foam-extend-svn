...
Description
 ...
 ICE Revision: $Id: funkySetFields.C 1845 2010-10-26 19:52:40Z bgschaid $
\*---------------------------------------------------------------------------*/
...
(
    ...
    Info << " Setting " << setCells << " of " << tmp->size() << " cells" <<
    endl;
...
#   include "addRegionOption.H"
    ...
    argList::validOptions.insert("valuePatches",
                                 "<list of patches that get a fixed value>");
    argList::validOptions.insert(
        "dictExt",
        "<extension to the default funkySetFieldsDict-dictionary>");

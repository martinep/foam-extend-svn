...
Description
    Calculates the difference for a vector field

    Revision: $Id: /local/openfoam/Utilities/PostProcessing/vectorFieldDifference/vectorFieldDifference.C 1871 2007-08-22T16:54:01.619148Z bgschaid  $ 
\*---------------------------------------------------------------------------*/
...
#   include "addRegionOption.H"
    ...
    Foam::argList::validArgs.append("vectorField");
        ...
        if(firstTime) {
            ...
            volVectorField deltaField
                (
                    ...
                    mesh,
                    dimensionedVector("delta"+fieldName,theField.dimensions()/runTime.dimensions(),vector::zero)                
            );
